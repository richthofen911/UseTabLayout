...
@DatabaseTable(tableName = "ap1beacon")

public class Ap1Beacon implements Comparable<Ap1Beacon>{
    ...
    public int compareTo(@NonNull Ap1Beacon ap1Beacon){
        return (Integer.parseInt(getRssi()) - Integer.parseInt(ap1Beacon.getRssi()));
    }
}
