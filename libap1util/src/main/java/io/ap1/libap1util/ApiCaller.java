...
public class ApiCaller {
    ...
    /**
     * config parameters for an API call
     * @param urlBase server url
     * @param urlPath api path
     * @param urlParams params added in url, usually for GET request
     * @param postParams params for POST request
     * @param method HTTP request method GET/POST or others
     * @return
     */
